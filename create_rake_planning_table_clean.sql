...
CREATE TABLE RAKE_PLANNING (
    ...
    Base_Depot NVARCHAR(50) NULL,
    Rake_Operator NVARCHAR(100) NULL,
    Haulage_Paid_By NVARCHAR(50) NULL,
    Trip_No NVARCHAR(50) NULL UNIQUE,
...
-- Create trigger for RAKE_PLANNING UpdatedAt
...
-- Insert sample data into RAKE_PLANNING
...
-- Insert sample rakes into RAKE_MASTER
